...
st.sidebar.write("1. put a youtube link in the blank")
st.sidebar.write("2. click the button and wait for a minute!")
st.sidebar.write("")
st.sidebar.header("link")
st.sidebar.page_link("https://youtube.com/", label="YouTube", icon="🏁")
